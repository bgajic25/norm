...
class EnglishCurrencyHandler(EnglishBaseHandler):
    """Normalizes currency formats like €1,234.56, $11,230.00, 1,234.56€, or 500 USD."""
    ...
    def __init__(self):
        ...
        self._symbol_map = {
            ...
            "INR": "INR", "CAD": "CAD", "AUD": "AUD", "BTC": "BTC"
        }
